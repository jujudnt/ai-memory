...
function isIcloudWebApprovalError(message = "") {
  return /Protection avancée|Accès aux données iCloud sur le Web|X-APPLE-WEBAUTH-TOKEN|PCS/i.test(
    message,
  );
}
